...
async def main():
    ...
    Resuma o feedback do cliente em uma frase curta. Seja neutro e conciso.
    ...
    Classifique o feedback como: Positivo, Negativo ou Solicitação de Recurso.
    """
    ...
    feedback="""
    Eu uso o painel de controle todos os dias para monitorar as métricas e, no geral, funciona bem.

    Mas quando estou trabalhando até tarde da noite, a tela brilhante incomoda muito meus olhos.

    Se vocês adicionassem uma opção de modo escuro, a experiência seria muito mais confortável.
    """
